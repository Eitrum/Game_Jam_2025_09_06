...
{
    [AddComponentMenu("Toolkit/Inventory/Container (Weighted)")]
    public class WeightedContainerBehaviour : MonoBehaviour, IWeightContainer, IContainerEvents
    {
        ...
        public bool AddItem(IItem item) {
            if(item is IItemWeight iw) {
                var currentWeight = CurrentWeight;
                if(iw.Weight + currentWeight > MaxWeight) {
                    return false;
                }
            }
