...
namespace Toolkit.Unit {
    [AddComponentMenu("Toolkit/Unit/Traits")]
    public class TraitsBehaviour : MonoBehaviour, ITrait {
        #region Variables

        public const float MIN = TraitsUtility.MIN;
        public const float MAX = TraitsUtility.MAX;
