...
namespace Toolkit.Unit {
	public interface ISkills {
		ISkill Illusion { get; }
		ISkill Conjuration { get; }
		ISkill Destruction { get; }
		ISkill Restoration { get; }
		ISkill Alteration { get; }
		ISkill Enchanting { get; }
		ISkill Smithing { get; }
		ISkill Heavy_Armor { get; }
		ISkill Block { get; }
		ISkill Two_Handed { get; }
		ISkill One_Handed { get; }
		ISkill Archery { get; }
		ISkill Light_Armor { get; }
		ISkill Sneak { get; }
		ISkill Lockpicking { get; }
		ISkill Pickpocket { get; }
		ISkill Speech { get; }
		ISkill Alchemy { get; }
		ISkill GetSkill(SkillType type);
		ISkill[] GetSkills(SkillCategory category);
		ISkill[] GetAllSkills();
	}
