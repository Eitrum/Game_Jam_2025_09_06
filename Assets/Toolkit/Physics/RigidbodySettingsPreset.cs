...
{
    [CreateAssetMenu(fileName = "Rigidbody Settings", menuName = "Toolkit/Physics/Rigidbody Settings")]
    public class RigidbodySettingsPreset : ScriptableObject, IRigidbodySettings
    {
        #region Variables
